...
**[Logística Humanitária](#Logística Humanitária)**
...
**[Problemas de Localização de P-Medianas](#Problemas de Localização de P-Medianas)**

**[Problemas de Roteamento de Veículos](#Problemas de Roteamento de Veículos)**

**[Formulação Matemática para PRV](#Formulação Matemática para PRV)**
...
## 1.1 Logística Humanitária {#Logística Humanitária}
...
## 5. Problemas de Localização de P-Medianas {Problemas de Localização de P-Medianas}
...
## 6. Problemas de Roteamento de Veículos (PRV) {Problemas de Roteamento de Veículos}
...
## 7. Formulação Matemática para PRV {Formulação Matemática para PRV}

Exibição das equações matemáticas de minimização de custos e restrições do modelo.

$z= \sum_{i,j}\left ( c{ij} \sum{k}^{}x{ijk}\right)$

Sujeito a:

$\sum_{k}^{}y{ik}=1\quad \text{para} \quad i=2,...,n \sum{k}^{}y{ik}=m  \quad \text{para} \quad  i=1$
